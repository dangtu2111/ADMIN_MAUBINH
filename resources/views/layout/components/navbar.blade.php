            ...
            <div class="app-search dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu dropdown-menu-animated dropdown-lg" id="search-dropdown">
                    ...
                    <div class="notification-list">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <div class="d-flex">
                                <img class="d-flex me-2 rounded-circle" src="images/avatar-2.jpg" alt="Generic placeholder image" height="32">
                                <div class="w-100">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <div class="d-flex">
                                <img class="d-flex me-2 rounded-circle" src="images/avatar-5.jpg" alt="Generic placeholder image" height="32">
                                <div class="w-100">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="images/avatar-2.jpg" class="img-fluid rounded-circle" alt="">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 text-truncate ms-2">
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <span class="account-user-avatar">
                        <img src="images/avatar-1.jpg" alt="user-image" width="32" class="rounded-circle">
                    </span>
